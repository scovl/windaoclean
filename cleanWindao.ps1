...
# Tudo o que está comentando, será ignorado. Os Tweaks são executados na ordem em que estão listados pelas funções abaixo.
# O PC será reiniciado ao fim da execução do script.
##########
# Default preset
$tweaks = @(
	### Requer admin ###
